    ...
    <main class="main">
      ...
      <div class="container">
        <div class="col-lg-10">
          ...
          <form class="needs-validation" action="../php/procedimientos/agregar_procedimiento.php" method="post"
            name="form_procedimientos" id="form_procedimientos" style="margin-left: 50px;">
            <div class="row g-3">
              <div class="col-sm-6">
